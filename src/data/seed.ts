...
export const ITEMS: Item[] = [
  ...
  { id: 6, kind: 'free', free: true, helpWanted: true, helpFee: 5, title: 'Rug, 5 × 7, grey', cat: 'Furniture', cond: 'Vacuumed', loc: 'Carman 8', ago: '7h', seller: 'Tesia O.', handoffs: 9, since: 'Sep 2023', spot: 'Carman front desk', desc: 'Covers most of a Carman double. Rolled and tied, heavier than it looks — bring a friend.' },
  ...
  { id: 11, kind: 'rent', free: false, rentRate: 5, rentPeriod: 'week', title: 'Power drill + bit set', cat: 'Supplies', cond: 'Works', loc: 'Wallach 5', ago: '2h', seller: 'Ana G.', handoffs: 6, since: 'Sep 2024', spot: 'Butler steps', desc: 'Nobody needs to own a drill for one shelf. Rent it for a week and bring it back charged.' },
