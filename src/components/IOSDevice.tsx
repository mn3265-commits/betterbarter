...
/**
 * Simplified iOS device frame (402 × 874) used only to present the prototype.
 * Not part of the product — the app is only what sits inside the bezel.
 * Adapted from the handoff's ios-frame.jsx.
 */
...
export function IOSDevice({ children }: { children: ReactNode }) {
  return (
    ...
    >
      ...
      />
      {/* status bar overlays the top of the screen */}
